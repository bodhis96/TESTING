...
WebElement e2=driver.findElement(By.xpath("//input[@value='Sign Up']"));
...
if(e2.isDisplayed())
{
	System.out.println("Button labelled Search is Displayed on the page-No Defect");
}
else
{
	System.out.println("Button labelled Search is not displayed on the page-A Defect");
